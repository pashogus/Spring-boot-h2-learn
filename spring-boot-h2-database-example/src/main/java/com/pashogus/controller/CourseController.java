...
import com.pashogus.repository.CourseRepository;
...
public class CourseController {
    ...
    public List < Course > getCoursesByInstructor(@PathVariable(value = "postId") int instructorId) {
        return courseRepository.findByInstructorId(instructorId);
    }

    @PostMapping("/instructors/{instructorId}/courses")
    public Course createCourse(@PathVariable(value = "instructorId") int instructorId,
    ...
    public Course updateCourse(@PathVariable(value = "instructorId") int instructorId,
        @PathVariable(value = "courseId") int courseId,  @RequestBody Course courseRequest)
    ...
    public ResponseEntity < ? > deleteCourse(@PathVariable(value = "instructorId") int instructorId,
        @PathVariable(value = "courseId") int courseId) throws ResourceNotFoundException {
